...
def lzw_compress(uncompressed):
    ...
    # FIXED INDENTATION: These two lines must run AFTER the loop finishes
    if w:
        compressed.append(dictionary[w])
    return compressed
...
image_path = 'Cheetah.jpg'  # Replace with your image
...
# Show original image
cv2.imshow("Original Image(Vanya-CS24058)", img)
cv2.waitKey(0)
