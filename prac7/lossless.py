...
# ---------- Load the image ----------
image_path = 'Cheetah.jpg'  # Replace with your file
...
# ---------- Display Images ----------cv2.imshow("Original", image)
cv2.imshow("Lossy JPEG(Vanya-CS24058)", cv2.imread(lossy_output))
cv2.imshow("Lossless PNG(Vanya-CS24058)", cv2.imread(lossless_output))
cv2.waitKey(0)
